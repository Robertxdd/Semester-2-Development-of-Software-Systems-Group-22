    ...
    public class AssetDataManager
    {
        ...
        public static ObservableCollection<ProductionUnits> baseScenario2Units { get; private set; } = new();

        public static ObservableCollection<ProductionUnits> scenario1Units { get; private set; } = new();
        public static ObservableCollection<ProductionUnits> scenario2Units { get; private set; } = new();
